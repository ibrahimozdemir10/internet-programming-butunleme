                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-8 col-md-8">
                                            <div class="input_field">
                                                <input type="text" class="form-control" name="kelime" placeholder="Arana yapmak istediğiniz bilgiyi yazınız." required="required">
                                            </div>
                                        </div>
    ...
    <div class="explorer_europe">
        <div class="container" style="padding-top:20px;">
            ...
            if($hizmetler!=false)
            {
                ...
                {
                    if(!empty($hizmetler[$i]["resim"])) {$resim=$hizmetler[$i]["resim"];}else{$resim='varsayilan.jpeg';}
                    ?>
