  <?php
    if(!empty($_GET["seflink"]))
    {
        ...
        $veri=$VT->VeriGetir("bloglar","WHERE seflink=? AND durum=?",array($seflink,1),"ORDER BY ID ASC",1);
        if($veri!=false)
        {
  ?>
  <!-- bradcam_area  -->
        ...
        <div class="container">
            ...
            if(!empty($veri[0]["resim"]))
            {
                ...
                <div class="col-xl-6 col-md-6">
                   <img src="<?=SITE?>images/bloglar/<?=$veri[0]["resim"]?>" style="width:100%; height:auto;">
                   </div>
                   <div class="col-xl-6 col-md-6">
